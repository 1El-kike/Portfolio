...
export const Cuadro = ({ num, text }) => (
  ...
  >
    <div className="flex">
      <p className="font-extrabold text-yellow-500 text-7xl ps-2">{num}</p>
      <span className="top-5 mt-1 ms-2 font-extrabold tracking-widest text-gray-700 text-yellow-500 text-2xl">
        +
      </span>
    </div>
