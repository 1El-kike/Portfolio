        ...
        <Modal.Body>
          <Form>
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
              ...
              <Form.Control type="text" placeholder="" autoFocus></Form.Control>
            </Form.Group>
    ...
    return (
      <>
        <Breadcrumb onClick={(e) => changetabla(e)}>
          ...
          <Breadcrumb.Item href="#">{p}</Breadcrumb.Item>
          <Breadcrumb.Item href="#">{x}</Breadcrumb.Item>
        </Breadcrumb>
      </>
    );
  };
            ...
            <div className="row" id={item}>
              <div className="col-8 mt-1 d-flex align-items-center bg-light">
                <div className="d-flex">
                  <span
                    className="ms-1"
                    style={{ color: "rgb(88, 89, 90)", fontWeight: "600" }}
                  >
                    {e.d}
                  </span>
                  <div className="ps-3">
              ...
              <div className="col-4 mt-1 d-flex align-items-end bg-light rounded">
                <div className="d-flex gap-1  mt-2 mb-2">
                  <button
                    onClick={add}
                    className="btn btn-info p-2 pt-1 pb-1 align-items-center"
                  >
                    <i className="fa-solid fa-add"></i>
                  </button>
                  <button
                    onClick={edit}
                    className="btn btn-primary p-2 pt-1 pb-1"
                  >
                    <i className="fa-solid fa-edit"></i>
                  </button>
                  <button
                    onClick={(e) => deletechange(e)}
                    className="btn btn-danger p-2 pt-1 pb-1"
                  >
      ...
      {nume == 1 ? (
        <div className="row">
          <div className="col-12 d-flex justify-content-between">
            <DivBreadcrumb e={"Jefe"} p={"Subordinado"} x={"Administrador"} />
          </div>
                ...
                {list.map((element) => (
                  ...
                  >
                    <div className="ms-2 me-auto">
                      <div className="fw-bold">{element.cargo}</div>
                      {element.description}
                    </div>
          ...
          <div className="row">
            <div className="col-12 d-flex justify-content-between">
              <div onClick={() => setopens(true)}>
                <DivBreadcrumb e={"Tools"} p={"Structure"} x={"Changelog"} />
              </div>
            </div>
                ...
                <Accordion bg="lingh" defaultActiveKey="">
                  <Accordion.Item eventKey="0">
                    <Accordion.Header className="d-flex">
                      <span className="fas fa-envelope-open  p-1"></span>
                      {[elem.list1[0].name]}
                    </Accordion.Header>
                    <Accordion.Body>
                      {[elem.list1[0].ele][0].map((e, i) => (
                        <li className="nav-link ps-1 pb-1  li" key={i}>
                          {e}
                        </li>
                      ))}
                    </Accordion.Body>
                  ...
                  <Accordion.Item eventKey="1">
                    <Accordion.Header className="d-flex">
                      <span className="fas fa-calendar-day  p-1"></span>
                      {[elem.list2[0].name]}
                    </Accordion.Header>
                    <Accordion.Body>
                      {[elem.list2[0].ele][0].map((e, i) => (
                        <li className="nav-link ps-1 pb-1  li" key={i}>
                          {e}
                        </li>
                      ))}
                  ...
                  <Accordion.Item eventKey="2">
                    <Accordion.Header className="d-flex">
                      <span className="fas fa-table  p-1"></span>
                      {[elem.list3[0].name]}
                    </Accordion.Header>
                    <Accordion.Body>
                      {[elem.list3[0].ele][0].map((e, i) => (
                        <li className="nav-link ps-1 pb-1  li" key={i}>
                          {e}
                        </li>
                      ))}
                  ...
                  <Accordion.Item eventKey="3">
                    <Accordion.Header className="d-flex">
                      <span className="fas fa-fire p-1"></span>
                      {[elem.list4[0].name]}
                    </Accordion.Header>
                    <Accordion.Body>
                      {[elem.list4[0].ele][0].map((e, i) => (
                        <li className="nav-link ps-1 pb-1  li" key={i}>
                          {e}
                        </li>
                      ))}
                  ...
                  <Accordion.Item eventKey="4">
                    <Accordion.Header className="d-flex">
                      <span className="fas fa-question-circle  p-1"></span>
                      {[elem.list5[0].name]}
                    </Accordion.Header>
                    <Accordion.Body>
                      {[elem.list5[0].ele][0].map((e, i) => (
                        <li className="nav-link ps-1 pb-1  li" key={i}>
                          {e}
                        </li>
                      ))}
                  ...
                  <Accordion.Item eventKey="5">
                    <Accordion.Header className="d-flex">
                      <span className="fas fa-wrench p-1"></span>
                      <span>{[elem.list6[0].name]}</span>
                    </Accordion.Header>
                    <Accordion.Body>
                      {[elem.list6[0].ele][0].map((e, i) => (
                        <li className="nav-link ps-1 pb-1  li" key={i}>
                          {e}
                        </li>
                      ))}
        ...
        nume == 3 && (
          <div className="row">
            ...
            {opens2 && <DivButton datos={datos.new} />}
          </div>
        )
      )}
    </div>
